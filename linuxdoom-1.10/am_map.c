...
{
    for (int i = 0; i < 10; i++) {  // i isn't being reused, so I moved the declaration into the for loop
...
void AM_drawWalls(void)
{
    ...
    for (i = 0; i < numlines; i++)
    {
      ...
      if (cheating || (lines[i].flags & ML_MAPPED))
      {
        ...
        {
          // 8/21/2023: I think I can unnest this?
...
void AM_drawPlayers(void)
{
    ...
    for (i = 0; i < MAXPLAYERS; i++)
    {
      ...
      //   continue;
      // }
      // Condensing the two if statements above into one
